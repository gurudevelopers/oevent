...
data class MerchantDTO(
    ...
    val createdDateAndTime: Long,
    val modifiedDateAndTime: Long,
)

@Serializable
data class MerchantEventCatalogDTO(
    val id: String,
    val eventId: String,
...
@Serializable
data class MerchantEventStaffDTO(
    val id: String,
    val merchantId: String,
    val eventId: String,
    val name: String,
...
@Serializable
data class MerchantRegistrationToEventDTO(
    val id: String,
    val merchantId: String,
    val eventId: String,
...
data class CustomerTransactionDTO(
    ...
    val tokenRedeemedDateAndTime: Long
)
